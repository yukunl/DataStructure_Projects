  ...
  public Sequence(int[] command) {
    ...
    switch (sequenceType) {
      case ARITHMETIC: // call the constructor of the ArithmeticSequenceGenerator class to create
        ...
        break;
      case GEOMETRIC:
        // call the constructor of the GeometricSequenceGenerator class
        // to create an iterator over an geometric sequence with inital emelment
        //command[1], ratio command[2] and size stored at command[3]
